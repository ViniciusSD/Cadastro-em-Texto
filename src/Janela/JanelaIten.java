...
import Controle.ControllerArquivoTextoItens;
 ...
 * @author Vinicius
 */
public class JanelaIten extends javax.swing.JFrame {
    
    ControllerArquivoTextoItens controle = new ControllerArquivoTextoItens();
    ...
    private void BuscaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BuscaMouseClicked
        ...
        Itens i = controle.buscarItens(id);
    ...
    private void EditaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_EditaMouseClicked
        ...
        controle.editarItens(Integer.parseInt(jTextFieldId.getText()));
        listarTab(); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JanelaIten.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JanelaIten().setVisible(true);
            }
        });
    }
